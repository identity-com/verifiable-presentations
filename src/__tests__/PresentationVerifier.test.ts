...
describe('PresentationVerifier', () => {
    ...
    describe('Non cryptographically secure verify', () => {
        ...
        it('should return true if the credential is valid', async () => {
            const verified = await verifier.nonCryptographicallySecureVerify(emailCredential as Credential);
            expect(verified).toBeTruthy();
        });

        it('should be able to verify a credential twice', async () => {
            let verified = await verifier.nonCryptographicallySecureVerify(emailCredential as Credential);
            expect(verified).toBeTruthy();
        ...
        it('should return false if a leave target hash does not match', async () => {
            const invalidEmailCredential = R.clone(emailCredential);
        ...
        it('should return false if a leave has an invalid value', async () => {
            const invalidEmailCredential = R.clone(emailCredential);
